...
{{ ascii_moon_animation() }}

### How to use it?

In a bash terminal:
```bash
curl -s "https://aleyan.com/projects/ascii-side-of-the-moon"
```
Result:
...
[https://github.com/aleyan/ascii-side-of-the-moon](https://github.com/aleyan/ascii-side-of-the-moon)
